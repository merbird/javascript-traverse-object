      ...
      if (obj.hasOwnProperty(key)) {
         ...
         if (typeof obj[key] === 'object' && obj[key] !== null) {
            if (Array.isArray(obj[key])) {
               if (map) {
                  console.log(`${paddingChars}Array ${key}`);
               };
            } else {
               if (map) {
                  console.log(`${paddingChars}Object ${key}`);
               };
            }
            ...
            if (map) {
               console.log(`${paddingChars}key ${key} : value ${obj[key]}`);
            };
         }
      }
   }
...
//# sourceMappingURL=objectTraverse.js.map